  ...
  styles: [
    `
      ...
      @media (max-width: 899px) {
        .bar {
          /* Keep the mobile masthead compact so it never eats meaningful
      ...
      @media (max-width: 559px) {
        .brand {
          /* The compact symbol mark reads small at the same height as the
             full lockup — a touch taller keeps it feeling deliberate. */
          height: 30px;
        }
      }
      .brand-mark {
